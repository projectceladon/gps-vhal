...
namespace android
{
    ...
    int VirtualFakeCamera2::constructDefaultRequest(
    ...
    int VirtualFakeCamera2::allocateStream(
        uint32_t width,
        uint32_t height,
        int format,
        ...
        uint32_t *max_buffers)
    {
        ...
        if (format != HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED)
        {
            ...
            {
                if (format == (int)kAvailableFormats[formatIdx])
                    break;
            }
        ...
        case HAL_PIXEL_FORMAT_BLOB:
            ...
            availableSizeCount = mFacingBack ? sizeof(kAvailableJpegSizesBack) / sizeof(uint32_t) : sizeof(kAvailableJpegSizesFront) / sizeof(uint32_t);
            break;
        ...
        case HAL_PIXEL_FORMAT_YCrCb_420_SP:
            ...
            availableSizeCount = mFacingBack ? sizeof(kAvailableProcessedSizesBack) / sizeof(uint32_t) : sizeof(kAvailableProcessedSizesFront) / sizeof(uint32_t);
            break;
        default:
    ...
    int VirtualFakeCamera2::registerStreamBuffers(
        uint32_t stream_id,
        int num_buffers,
    ...
    int VirtualFakeCamera2::allocateReprocessStreamFromStream(
                                          ...
                                          int32_t ext2)
    {
        ...
        if (trigger_id == CAMERA2_EXT_TRIGGER_TESTING_DISCONNECT)
        {
            ...
            gVirtualCameraFactory.onStatusChanged(
                mCameraID,
    ...
    bool VirtualFakeCamera2::ConfigureThread::isStreamInUse(uint32_t id)
    {
        ...
        if (mNextBuffers == NULL)
            return false;
        for (size_t i = 0; i < mNextBuffers->size(); i++)
        {
            if ((*mNextBuffers)[i].streamId == (int)id)
                return true;
        }
        return false;
    }
    ...
    VirtualFakeCamera2::ReadoutThread::~ReadoutThread()
    {
    ...
    void VirtualFakeCamera2::ReadoutThread::setNextOperation(
        bool isCapture,
        camera_metadata_t *request,
        Buffers *buffers)
    {
    ...
    void VirtualFakeCamera2::ReadoutThread::onJpegDone(
    ...
    void VirtualFakeCamera2::ReadoutThread::onJpegInputDone(
    ...
    status_t VirtualFakeCamera2::ReadoutThread::collectStatisticsMetadata(
...
#undef READ_IF_OK
    ...
    const float VirtualFakeCamera2::ControlThread::kAeScanStartRate =
                                                        ...
                                                        bool aeLock, uint8_t aeState, nsecs_t *maxSleep)
    {
                 ...
                 (aeState == ANDROID_CONTROL_AE_STATE_PRECAPTURE))
        {
            ...
            else
            {
                ...
                if (mExposureTime < kMinExposureTime)
                    mExposureTime = kMinExposureTime;
            }
        }
    ...
    status_t VirtualFakeCamera2::constructStaticInfo(
...
#undef ADD_OR_SIZE
    ...
    status_t VirtualFakeCamera2::constructDefaultRequest(
        int request_template,
        camera_metadata_t **request,
        bool sizeRequest) const
    {
