...
#include "acircles_pattern_1280_720.c"
    ...
    void VirtualFakeRotatingCameraDevice::read_rotation_vector(double *yaw, double *pitch, double *roll)
    {
        read_sensor();
                                                          ...
                                                          uint32_t pix_fmt)
    {
        ...
        const status_t res =
            VirtualCameraDevice::commonStartDevice(width, height, pix_fmt);
