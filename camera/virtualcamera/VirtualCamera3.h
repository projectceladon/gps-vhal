...
#ifndef HW_EMULATOR_CAMERA_VIRTUALD_CAMERA3_H
#define HW_EMULATOR_CAMERA_VIRTUALD_CAMERA3_H
...
namespace android
{
    ...
    /**
     * Encapsulates functionality common to all version 3.0 virtual camera devices
     *
     ...
     */
    class VirtualCamera3 : public camera3_device, public VirtualBaseCamera
    {
    public:
    ...
    protected:
         ...
         * dispatch the call into an instance of VirtualCamera3 class defined in
