...
#ifndef HW_EMULATOR_CAMERA_VIRTUALD_FAKE_CAMERA2_H
#define HW_EMULATOR_CAMERA_VIRTUALD_FAKE_CAMERA2_H

/*
 * Contains declaration of a class VirtualFakeCamera2 that encapsulates
 ...
 */
class VirtualFakeCamera2 : public VirtualCamera2 {
public:
    /* Constructs VirtualFakeCamera instance. */
    VirtualFakeCamera2(int cameraId, bool facingBack, struct hw_module_t *module);
...
public:
    /* Initializes VirtualFakeCamera2 instance. */
...
public:
    ...
    /****************************************************************************
     * VirtualCamera2 abstract API implementation.
     ***************************************************************************/
protected:
    /** Request input queue */
...
private:
    ...
    status_t constructStaticInfo(camera_metadata_t **info, bool sizeRequest) const;

    /** Two-pass implementation of constructDefaultRequest */
    status_t constructDefaultRequest(int request_template, camera_metadata_t **request,
                                     bool sizeRequest) const;
    /** Helper function for constructDefaultRequest */
    static status_t addOrSize(camera_metadata_t *request, bool sizeRequest, size_t *entryCount,
                              size_t *dataCount, uint32_t tag, const void *entry_data,
                              size_t entry_count);
    ...
    public:
        ConfigureThread(VirtualFakeCamera2 *parent);
        ~ConfigureThread();
    ...
    public:
        ReadoutThread(VirtualFakeCamera2 *parent);
        ~ReadoutThread();
        ...
        void setNextOperation(bool isCapture, camera_metadata_t *request, Buffers *buffers);
        bool isStreamInUse(uint32_t id);
        int getInProgressCount();
    ...
    public:
        ControlThread(VirtualFakeCamera2 *parent);
        ~ControlThread();
    ...
    private:
        ...
        int updateAeScan(uint8_t aeMode, bool aeLock, uint8_t aeState, nsecs_t *maxSleep);
...
#endif /* HW_EMULATOR_CAMERA_VIRTUALD_FAKE_CAMERA2_H */
