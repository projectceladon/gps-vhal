...
//////////////////////////////////////////////////////////////////////////////////
    ...
    status_t VirtualFakeCamera3::configureStreams(
    ...
    status_t VirtualFakeCamera3::registerStreamBuffers(
...
#define ADD_STATIC_ENTRY(name, varptr, count) \
    ...
    return res
        ...
        const uint8_t aeLockAvailable = hasCapability(BACKWARD_COMPATIBLE) ? ANDROID_CONTROL_AE_LOCK_AVAILABLE_TRUE : ANDROID_CONTROL_AE_LOCK_AVAILABLE_FALSE;
        ...
        const uint8_t awbLockAvailable = hasCapability(BACKWARD_COMPATIBLE) ? ANDROID_CONTROL_AWB_LOCK_AVAILABLE_TRUE : ANDROID_CONTROL_AWB_LOCK_AVAILABLE_FALSE;
        ...
        const uint8_t supportedHardwareLevel =
            hasCapability(FULL_LEVEL) ? ANDROID_INFO_SUPPORTED_HARDWARE_LEVEL_FULL : ANDROID_INFO_SUPPORTED_HARDWARE_LEVEL_LIMITED;
...
//            ALOGV("%s: Pre capture trigger = %d", __FUNCTION__, precaptureTrigger);
  ...
  //          ALOGV("%s: Pre capture trigger was present? %zu",
      ...
      //            e.count);
        ...
        if (precaptureTrigger || mAeState == ANDROID_CONTROL_AE_STATE_PRECAPTURE)
        {
                    ...
                    mAeTargetExposureTime / 10)
            {
                ...
                mAeCounter = 0;
                mAeState = aeLocked ? ANDROID_CONTROL_AE_STATE_LOCKED : ANDROID_CONTROL_AE_STATE_CONVERGED;
            }
            else
            {
                // Converge some more
    ...
    status_t VirtualFakeCamera3::doFakeAWB(CameraMetadata &settings)
    {
        ...
        case ANDROID_CONTROL_AWB_MODE_SHADE:
            ...
            mAwbState = awbLocked ? ANDROID_CONTROL_AWB_STATE_LOCKED : ANDROID_CONTROL_AWB_STATE_CONVERGED;
            break;
        default:
  ...
  //          ALOGVV("%s: Frame %d: Sensor started exposure at %lld",
    ...
    VirtualFakeCamera3::ReadoutThread::ReadoutThread(VirtualFakeCamera3 *parent) : mParent(parent), mJpegWaiting(false)
    {
    }
   ...
   //     ALOGVV("Sensor done with readout for frame %d, captured at %lld ",
    ...
    void VirtualFakeCamera3::ReadoutThread::onJpegDone(
    ...
    void VirtualFakeCamera3::ReadoutThread::onJpegInputDone(
