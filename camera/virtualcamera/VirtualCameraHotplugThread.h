...
#ifndef HW_EMULATOR_CAMERA_VIRTUALD_CAMERA_HOTPLUG_H
#define HW_EMULATOR_CAMERA_VIRTUALD_CAMERA_HOTPLUG_H
 ...
 *
 * Refer to FAKE_HOTPLUG_FILE in VirtualCameraHotplugThread.cpp
 */
