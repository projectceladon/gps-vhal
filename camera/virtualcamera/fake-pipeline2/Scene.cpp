...
// #define LOG_NDEBUG 0
#define LOG_TAG "VirtualCamera_Scene"
#include <log/log.h>
#include <stdlib.h>
#include <cmath>
#include "Scene.h"
...
const uint8_t Scene::kScene[Scene::kSceneWidth * Scene::kSceneHeight] = {
    //      5         10        15        20
    K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, S, S,
    S, K, H, K, K, K, R, K, R, K, R, K, K, K, M, G, G, K, S, K, K, K, H, H, H,
    K, R, K, R, K, R, K, K, K, M, K, K, K, S, S, S, K, H, K, K, K, R, R, R, R,
    R, K, M, M, M, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,  // 5
    K, K, K, S, S, S, K, H, K, K, K, R, K, R, K, R, K, K, K, M, G, G, K, S, K,
    K, K, H, H, H, K, R, K, R, K, R, K, K, K, M, K, K, K, S, S, S, K, H, K, K,
    K, R, R, R, R, R, K, M, M, M, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,
    K, K, K, K, K, K, K, K, S, S, S, K, H, K, K, K, R, K, R, K, R, K, K, K, M,  // 10
    G, G, K, S, K, K, K, H, H, H, K, R, K, R, K, R, K, K, K, M, K, K, K, S, S,
    S, K, H, K, K, K, R, R, R, R, R, K, M, M, M, K, K, K, K, K, K, K, K, K, K,
    K, K, K, K, K, K, K, K, K, K, K, K, K, S, S, S, K, H, K, K, K, R, K, R, K,
    R, K, K, K, M, G, G, K, S, K, K, K, H, H, H, K, R, K, R, K, R, K, K, K, M,  // 15
    K, K, K, S, S, S, K, H, K, K, K, R, R, R, R, R, K, M, M, M, K, K, K, K, K,
    K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, S, S, S, K, H, K, K,
    K, R, K, R, K, R, K, K, K, M, G, G, K, S, K, K, K, H, H, H, K, R, K, R, K,
    R, K, K, K, M, K, K, K, S, S, S, K, H, K, K, K, R, R, R, R, R, K, M, M, M,  // 20
    //      5         10        15        20
};
#else
const uint8_t Scene::kScene[Scene::kSceneWidth * Scene::kSceneHeight] = {
    ...
    K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,
    K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,
    K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,  // 5
    K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,
    K, K, K, H, H, H, H, H, H, H, H, H, H, H, H, K, K, K, K, K, K, K, K, H, H,
    H, H, H, H, H, C, C, H, H, H, K, K, K, K, K, K, H, H, H, H, H, H, H, H, H,
    C, C, H, H, H, H, K, K, K, K, K, H, R, R, R, R, R, R, R, R, R, R, R, R, H,  // 10
    H, K, K, K, K, H, H, R, R, R, R, R, R, R, R, R, R, R, R, H, H, H, H, K, K,
    H, H, R, R, R, R, R, R, R, R, R, R, R, R, H, H, H, H, K, K, H, H, H, W, W,
    W, W, W, W, W, W, W, W, H, H, S, S, S, G, G, S, S, S, W, W, W, W, W, W, W,
    W, W, W, S, S, S, G, G, G, G, S, S, S, W, I, I, W, D, D, W, I, I, W, S, S,  // 15
    G, G, G, G, G, G, S, S, W, I, I, W, D, D, W, I, I, W, S, S, G, G, G, G, G,
    G, G, G, W, W, W, W, D, D, W, W, W, W, G, G, G, G, G, G, G, G, G, G, W, W,
    W, W, D, D, W, W, W, W, G, G, G, G, G, G, G, G, G, G, S, S, S, S, S, S, S,
    S, S, S, G, G, G, G, G, G, G, G, G, G, S, S, S, S, S, S, S, S, S, S, G, G,  // 20
    //      5         10        15        20
};
#endif
...
void Scene::setColorFilterXYZ(float rX, float rY, float rZ, float grX, float grY, float grZ,
                              float gbX, float gbY, float gbZ, float bX, float bY, float bZ) {
    mFilterR[0] = rX;
    mFilterR[1] = rY;
    mFilterR[2] = rZ;
    mFilterGr[0] = grX;
...
void Scene::calculateScene(nsecs_t time) {
    ...
    ALOGV("Sun XY: %f, %f, Shade XY: %f, %f", currentSunXY[0], currentSunXY[1], currentShadeXY[0],
          currentShadeXY[1]);
    ...
    float sunShadeXYZ[3] = {
        sunShadeLux / currentShadeXY[1] * currentShadeXY[0], sunShadeLux,
    ...
    for (int i = 0; i < NUM_MATERIALS; i++) {
        ...
        // Y = Y
        // Z = Y / y * (1 - x - y);
        float matXYZ[3] = {kMaterials_xyY[i][2] / kMaterials_xyY[i][1] * kMaterials_xyY[i][0],
                           kMaterials_xyY[i][2],
        ...
        mCurrentColors[i * NUM_CHANNELS + 0] =
            (mFilterR[0] * matXYZ[0] + mFilterR[1] * matXYZ[1] + mFilterR[2] * matXYZ[2]) *
            luxToElectrons;
        mCurrentColors[i * NUM_CHANNELS + 1] =
            (mFilterGr[0] * matXYZ[0] + mFilterGr[1] * matXYZ[1] + mFilterGr[2] * matXYZ[2]) *
            luxToElectrons;
        ...
        mCurrentColors[i * NUM_CHANNELS + 3] =
            (mFilterB[0] * matXYZ[0] + mFilterB[1] * matXYZ[1] + mFilterB[2] * matXYZ[2]) *
            luxToElectrons;

        ALOGV("Color %d RGGB: %d, %d, %d, %d", i, mCurrentColors[i * NUM_CHANNELS + 0],
              mCurrentColors[i * NUM_CHANNELS + 1], mCurrentColors[i * NUM_CHANNELS + 2],
              mCurrentColors[i * NUM_CHANNELS + 3]);
    }
