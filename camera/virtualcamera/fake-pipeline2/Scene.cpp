...
#define M (Scene::MOON * Scene::NUM_CHANNELS)
    ...
    const uint8_t Scene::kScene[Scene::kSceneWidth * Scene::kSceneHeight] = {
        ...
        K, K, K, S, S, S, K, H, K, K, K, R, K, R, K, R, K, K, K, M,
        G, G, K, S, K, K, K, H, H, H, K, R, K, R, K, R, K, K, K, M,
        K, K, K, S, S, S, K, H, K, K, K, R, R, R, R, R, K, M, M, M,
        K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, // 5
        K, K, K, S, S, S, K, H, K, K, K, R, K, R, K, R, K, K, K, M,
        G, G, K, S, K, K, K, H, H, H, K, R, K, R, K, R, K, K, K, M,
        K, K, K, S, S, S, K, H, K, K, K, R, R, R, R, R, K, M, M, M,
        K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,
        K, K, K, S, S, S, K, H, K, K, K, R, K, R, K, R, K, K, K, M, // 10
        G, G, K, S, K, K, K, H, H, H, K, R, K, R, K, R, K, K, K, M,
        K, K, K, S, S, S, K, H, K, K, K, R, R, R, R, R, K, M, M, M,
        K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,
        K, K, K, S, S, S, K, H, K, K, K, R, K, R, K, R, K, K, K, M,
        G, G, K, S, K, K, K, H, H, H, K, R, K, R, K, R, K, K, K, M, // 15
        K, K, K, S, S, S, K, H, K, K, K, R, R, R, R, R, K, M, M, M,
        K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K, K,
        K, K, K, S, S, S, K, H, K, K, K, R, K, R, K, R, K, K, K, M,
        G, G, K, S, K, K, K, H, H, H, K, R, K, R, K, R, K, K, K, M,
        K, K, K, S, S, S, K, H, K, K, K, R, R, R, R, R, K, M, M, M, // 20
        //      5         10        15        20
    };
#else
    const uint8_t Scene::kScene[Scene::kSceneWidth * Scene::kSceneHeight] = {
...
#undef M
    ...
    Scene::Scene(
        int sensorWidthPx,
        int sensorHeightPx,
        float sensorSensitivity) : mSensorWidth(sensorWidthPx),
