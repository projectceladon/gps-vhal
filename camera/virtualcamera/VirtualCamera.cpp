...
#define PrintParamDiff(current, new_par) (void(0))
    ...
    */
    ...
    void VirtualCamera::autoFocusComplete()
    {
    ...
    void VirtualCamera::enableMsgType(int32_t msg_type)
    {
        mCallbackNotifier.enableMessage(msg_type);
    }

    void VirtualCamera::disableMsgType(int32_t msg_type)
    {
    ...
    int VirtualCamera::isPreviewEnabled()
    {
    ...
    void VirtualCamera::stopRecording()
    {
        mCallbackNotifier.disableVideoRecording();
    }

    int VirtualCamera::isRecordingEnabled()
    {
    ...
    * VirtualCamera::getParameters(). */
    ...
    void VirtualCamera::set_callbacks(
    ...
    camera_device_ops_t VirtualCamera::mDeviceOps = {
        VirtualCamera::set_preview_window,
