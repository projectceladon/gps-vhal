...
namespace android
{
    ...
    status_t VirtualCameraDevice::Initialize(const char *name)
    {
        if (isInitialized())
        {
            ALOGW("%s: Virtual camera device is already initialized: mState = %d",
                  __FUNCTION__, mState);
            return NO_ERROR;
        }
    ...
    */
    ...
    VirtualCameraDevice::FrameLock::~FrameLock()
    {
    ...
    void VirtualCameraDevice::CameraThread::lockPrimaryBuffer()
    {
    ...
    bool
    VirtualCameraDevice::CameraThread::waitForFrameOrTimeout(nsecs_t timeout)
    {
    ...
    VirtualCameraDevice::CameraThread::FrameProducer::FrameProducer(
        VirtualCameraDevice *dev,
        ProduceFrameFunc producer,
        void *opaque,
        void *primaryBuffer,
    ...
    const void *
    VirtualCameraDevice::CameraThread::FrameProducer::getPrimaryBuffer() const
    {
        return mPrimaryBuffer;
    }

    int64_t
    VirtualCameraDevice::CameraThread::FrameProducer::getPrimaryTimestamp() const
    {
        return mPrimaryTimestamp;
    }

    void VirtualCameraDevice::CameraThread::FrameProducer::lockPrimaryBuffer()
    {
        mBufferMutex.lock();
    }
    ...
    bool VirtualCameraDevice::CameraThread::FrameProducer::hasFrame() const
    {
        return mHasFrame;
    }
    ...
    void VirtualCameraDevice::lockCurrentFrame()
    {
        mCameraThread->lockPrimaryBuffer();
    }

    void VirtualCameraDevice::unlockCurrentFrame()
    {
