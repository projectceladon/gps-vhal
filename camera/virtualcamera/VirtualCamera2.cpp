    ...
    */
                                                                                      ...
                                                                                      module)
    {
        ...
        mVendorTagOps.get_camera_vendor_section_name =
            VirtualCamera2::get_camera_vendor_section_name;
        mVendorTagOps.get_camera_vendor_tag_name =
            VirtualCamera2::get_camera_vendor_tag_name;
        mVendorTagOps.get_camera_vendor_tag_type =
            VirtualCamera2::get_camera_vendor_tag_type;
    ...
    status_t VirtualCamera2::closeCamera()
    {
        return NO_ERROR;
    }
    ...
    int VirtualCamera2::requestQueueNotify()
    {
        return INVALID_OPERATION;
    }

    /** Count of requests in flight */
    int VirtualCamera2::getInProgressCount()
    {
        return INVALID_OPERATION;
    }

    /** Cancel all captures in flight */
    int VirtualCamera2::flushCapturesInProgress()
    {
        return INVALID_OPERATION;
    }

    /** Construct a default request for a given use case */
    int VirtualCamera2::constructDefaultRequest(
    ...
    int VirtualCamera2::allocateStream(
        uint32_t width,
        uint32_t height,
        int format,
    ...
    int VirtualCamera2::registerStreamBuffers(
        uint32_t stream_id,
        int num_buffers,
    ...
    int VirtualCamera2::releaseStream(uint32_t stream_id)
    {
        return INVALID_OPERATION;
    }
    ...
    int VirtualCamera2::allocateReprocessStream(
        uint32_t width,
        uint32_t height,
        uint32_t format,
    ...
    int VirtualCamera2::releaseReprocessStream(uint32_t stream_id)
    {
        return INVALID_OPERATION;
    }
    ...
    const char *VirtualCamera2::getVendorSectionName(uint32_t tag)
    {
        return NULL;
    }

    const char *VirtualCamera2::getVendorTagName(uint32_t tag)
    {
        return NULL;
    }

    int VirtualCamera2::getVendorTagType(uint32_t tag)
    {
        return -1;
    }
    ...
    int VirtualCamera2::dump(int fd)
    {
        return INVALID_OPERATION;
    }
    ...
    const char *VirtualCamera2::get_camera_vendor_section_name(
    ...
    const char *VirtualCamera2::get_camera_vendor_tag_name(
        const vendor_tag_query_ops_t *v,
        uint32_t tag)
    {
        VirtualCamera2 *ec = static_cast<const TagOps *>(v)->parent;
    ...
    int VirtualCamera2::get_camera_vendor_tag_type(
        const vendor_tag_query_ops_t *v,
        uint32_t tag)
    {
        VirtualCamera2 *ec = static_cast<const TagOps *>(v)->parent;
