...
#ifndef HW_EMULATOR_CAMERA_VIRTUALD_FAKE_CAMERA_DEVICE_H
#define HW_EMULATOR_CAMERA_VIRTUALD_FAKE_CAMERA_DEVICE_H

/*
 * Contains declaration of a class VirtualFakeCameraDevice that encapsulates
 ...
 */
class VirtualFakeCameraDevice : public VirtualCameraDevice {
public:
    /* Constructs VirtualFakeCameraDevice instance. */
    explicit VirtualFakeCameraDevice(VirtualFakeCamera *camera_hal);

    /* Destructs VirtualFakeCameraDevice instance. */
    ~VirtualFakeCameraDevice();
...
#endif /* HW_EMULATOR_CAMERA_VIRTUALD_FAKE_CAMERA_DEVICE_H */
