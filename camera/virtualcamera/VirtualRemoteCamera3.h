...
#ifndef HW_EMULATOR_CAMERA_VIRTUALD_REMOTE_CAMERA3_H
#define HW_EMULATOR_CAMERA_VIRTUALD_REMOTE_CAMERA3_H

/*
 * Contains declaration of a class VirtualRemoteCamera3 that encapsulates
...
#include "remote-pipeline3/RemoteSensor.h"
 ...
 */
class VirtualRemoteCamera3 : public VirtualCamera3, private RemoteSensor::RemoteSensorListener {
public:
    VirtualRemoteCamera3(int cameraId, struct hw_module_t *module);
    virtual ~VirtualRemoteCamera3();
     ...
     */
    virtual status_t Initialize(const char *deviceName, const char *frameDims,
...
private:
     ...
     */
    void onRemoteSensorEvent(uint32_t frameNumber, Event e, nsecs_t timestamp);
...
private:
    ...
    public:
        ReadoutThread(VirtualRemoteCamera3 *parent);
        ~ReadoutThread();
...
#endif  // HW_EMULATOR_CAMERA_VIRTUALD_REMOTE_CAMERA3_H
