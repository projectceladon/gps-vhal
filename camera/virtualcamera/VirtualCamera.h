...
#ifndef HW_EMULATOR_CAMERA_VIRTUALD_CAMERA_H
#define HW_EMULATOR_CAMERA_VIRTUALD_CAMERA_H

/*
 * Contains declaration of a class VirtualCamera that encapsulates
 * functionality common to all version 1.0 virtual camera devices ("fake",
...
/* Encapsulates functionality common to all version 1.0 virtual camera devices
 ...
 */
class VirtualCamera : public camera_device, public VirtualBaseCamera {
public:
    /* Constructs VirtualCamera instance.
     * Param:
     *  cameraId - Zero based camera identifier, which is an index of the camera
     *      instance in camera factory's array.
     *  module - Virtual camera HAL module descriptor.
     */
    VirtualCamera(int cameraId, struct hw_module_t *module);

    /* Destructs VirtualCamera instance. */
...
public:
    /* Gets virtual camera device used by this instance of the virtual camera.
     */
    virtual VirtualCameraDevice *getCameraDevice() = 0;
...
public:
     ...
     * VirtualCameraDevice::FrameLock instance to lock the frame before
     * accessing it.
     ...
     */
    virtual void onNextFrameAvailable(nsecs_t timestamp, VirtualCameraDevice *camera_dev);
...
private:
     ...
     * dispatch the call into an instance of VirtualCamera class defined by the
...
private:
    ...
    static void set_callbacks(struct camera_device *dev, camera_notify_callback notify_cb,
...
#endif /* HW_EMULATOR_CAMERA_VIRTUALD_CAMERA_H */
