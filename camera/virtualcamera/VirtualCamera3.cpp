...
namespace android
{
    ...
    status_t VirtualCamera3::initializeDevice(
    ...
    status_t VirtualCamera3::configureStreams(
    ...
    status_t VirtualCamera3::registerStreamBuffers(
    ...
    const camera_metadata_t *VirtualCamera3::constructDefaultRequestSettings(
        int type)
    {
        ALOGE("%s: Not implemented", __FUNCTION__);
        return NULL;
    ...
    status_t VirtualCamera3::processCaptureRequest(
    ...
    int VirtualCamera3::register_stream_buffers(
    ...
    int VirtualCamera3::process_capture_request(
        const struct camera3_device *d,
