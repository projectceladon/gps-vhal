...
namespace android
{
    ...
    */
    ...
    status_t VirtualRemoteCamera3::Initialize(const char *deviceName,
    ...
    status_t VirtualRemoteCamera3::connectCamera(hw_device_t **device)
    {
        ...
        */
        ...
        {
            ALOGV("%s: mSensor is nullptr of mCameraSocketFD(%d) less than 0", __FUNCTION__, mCameraSocketFD);
        }
    ...
    */
    ...
    status_t VirtualRemoteCamera3::configureStreams(
    ...
    status_t VirtualRemoteCamera3::registerStreamBuffers(
        ...
        int type)
    {
        ...
        */
        ...
        const uint8_t controlMode = (type == CAMERA3_TEMPLATE_MANUAL) ? ANDROID_CONTROL_MODE_OFF : ANDROID_CONTROL_MODE_AUTO;
        ...
        if (hasCapability(BACKWARD_COMPATIBLE))
        {
            ...
            const uint8_t aeMode = (type == CAMERA3_TEMPLATE_MANUAL) ? ANDROID_CONTROL_AE_MODE_OFF : ANDROID_CONTROL_AE_MODE_ON;
            ...
            const uint8_t awbMode = (type == CAMERA3_TEMPLATE_MANUAL) ? ANDROID_CONTROL_AWB_MODE_OFF : ANDROID_CONTROL_AWB_MODE_AUTO;
    ...
    status_t VirtualRemoteCamera3::processCaptureRequest(
    ...
    return res
        ...
        */
        ...
        const uint8_t availableSceneModes[] = {
            hasCapability(BACKWARD_COMPATIBLE) ? ANDROID_CONTROL_SCENE_MODE_FACE_PRIORITY : ANDROID_CONTROL_SCENE_MODE_DISABLED};
...
#undef ADD_STATIC_ENTRY
    ...
    void VirtualRemoteCamera3::onRemoteSensorEvent(uint32_t frameNumber, Event e,
                                                nsecs_t timestamp)
    {
        switch (e)
        {
    ...
    VirtualRemoteCamera3::ReadoutThread::ReadoutThread(VirtualRemoteCamera3 *parent) : mParent(parent), mJpegWaiting(false)
    {
...
//        ALOGVV("Sensor done with readout for frame %d, captured at %lld ",
  //             mCurrentRequest.frameNumber, captureTime);
    ...
    void VirtualRemoteCamera3::ReadoutThread::onJpegDone(
    ...
    void VirtualRemoteCamera3::ReadoutThread::onJpegInputDone(
